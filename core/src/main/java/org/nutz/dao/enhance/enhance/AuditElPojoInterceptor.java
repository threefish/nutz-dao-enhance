 ...
 * date: 2023/3/18
 */
public class AuditElPojoInterceptor extends SimpleElPojoInterceptor {

    public AuditElPojoInterceptor(MappingField mf, String str, String event, boolean nullEffective) {
