...
import org.nutz.spring.boot.dao.spring.ddl.AutoGenerateDDL;
import org.nutz.spring.boot.dao.spring.ddl.AutoGenerateDDLConfigurer;
...
public class MapperScannerRegistrar implements ImportBeanDefinitionRegistrar {
    ...
    void registerBeanDefinitions(AnnotationMetadata annoMeta, AnnotationAttributes annoAttrs, BeanDefinitionRegistry registry, String beanName) {
        ...
        builder.addPropertyValue("autoGenerateDDL", new RuntimeBeanReference(AutoGenerateDDL.class));
