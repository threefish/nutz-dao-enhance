...
import org.nutz.spring.boot.dao.config.properties.NutzDaoProperties;
 ...
 */
@Component
public class DefaualtAutoGenerateDDL implements ApplicationContextAware, CommandLineRunner {
    ...
    public void run(String... args) {
        NutzDaoProperties nutzDaoProperties = applicationContext.getBean(NutzDaoProperties.class);
